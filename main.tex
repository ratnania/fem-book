...
\newcommand{\hbphi}{\hat{\boldsymbol{\varphi}}} 
\newcommand{\curl}{\nabla\times\,}
\renewcommand{\div}{\nabla\cdot\,}
\newcommand{\divs}{\mathrm{div}\,}
\newcommand{\rots}{\mathrm{curl}\,}
\newcommand{\rotv}{\mathbf{curl}\,}
\newcommand{\intgam}{\int_{\partial\Omega}}

%DG Brackets
\newcommand{\ljump}{\left[ \!\left[ }
\newcommand{\rjump}{\right]\! \right] }
\newcommand{\lbjump}{\left[\!\!  \left[ }
\newcommand{\rbjump}{\right]\!\! \right] }
\newcommand{\lav}{\left\{ \!\left\{ }
\newcommand{\rav}{\right\} \! \right\} }
\newcommand{\lbav}{\left\{ \!\!\left\{ }
\newcommand{\rbav}{\right\} \!\! \right\} }
...
\input{tex/part_1_chapter_1.tex}
\input{tex/part_1_chapter_2.tex}
\input{tex/part_1_historical_notes.tex}

%----------------------------------------------------------------------------------------
%	PART 2: Finite Elements method 
%----------------------------------------------------------------------------------------
\part{Abstract framework}
\input{tex/part_2_chapter_1.tex}
\input{tex/part_2_chapter_2.tex}
\input{tex/part_2_chapter_3.tex}
...
\input{tex/part_3_chapter_1.tex}
\input{tex/part_3_chapter_2.tex}
...
\input{tex/part_4_chapter_1.tex}
\input{tex/part_4_chapter_2.tex}
\input{tex/part_4_chapter_3.tex}
\input{tex/part_4_historical_notes.tex}

%----------------------------------------------------------------------------------------
%	PART 5: Linear Algebra 
%----------------------------------------------------------------------------------------
\part{Linear Algebra}
\input{tex/part_5_chapter_1.tex}
\input{tex/part_5_historical_notes.tex}
